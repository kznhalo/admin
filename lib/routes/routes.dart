...
import 'package:kozarni_ecome/screen/manage_partner_user_screen.dart';
import 'package:kozarni_ecome/screen/order_revenue_screen.dart';
...
const String orderRevenueScreen = '/orderRevenueScreen';
...
List<GetPage> routes = [
  ...
  GetPage(
    name: managePartnerUserScreen,
    page: () => ManagePartnerUser(),
  ),
  GetPage(
    name: orderRevenueScreen,
    page: () => OrderRevenueScreen(),
  ),
];
